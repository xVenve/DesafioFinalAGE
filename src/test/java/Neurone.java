...
public class Neurone {
	...
	/**
	 * Inicialización de una neurona con mutación a partir de otra. Genera pesos
	 * distintos aleatorios con un número aleatrorio gaussiano acotado por sigma. Si
	 * weightSigma==0, no hay mutación.
	 * 
	...
	/**
	 * Toma las salidas de las neuronas de la capa anterior, realiza la función y
	...
	public double process(double[] input) {
		...
		switch (this.method) {
		case 1:
			return sigmoid_function(exit); // Sigmoid
		case 2:
			return relu_function(exit); // ReLu
		case 3:
			return hyperbolic_function(exit); // Hyperbolic
		default:
			return exit; // Linear
		}
	}
